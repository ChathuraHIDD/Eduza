...
const TASK_BANK = {
  ...
  practice: (subject) => [
    `Attempt ${subject} past final exam paper (timed)`,
    ...
    `Identify patterns in ${subject} past final exam questions`,
  ],
  revise: (subject) => [
  ...
  final: (subject) => [
    ...
    `Skim ${subject} past final exam for question patterns`,
 ...
 *   mark         — number
 */
export function generateFinalExamSchedule(form) {
