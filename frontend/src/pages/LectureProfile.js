...
const lecturers = [
  {
    ...
    bio: 'Dr. Chen is a leading researcher in modern web technologies with over 12 years of industry and academic experience. She has published 30+ peer-reviewed papers and leads the university\'s Web Innovation Lab.',
    coursesList: [
  ...
  },
  {
    ...
    bio: 'Prof. Williams is a world-renowned algorithmist and author of the textbook "Algorithmic Thinking" used in over 200 universities. His research focuses on computational complexity and optimization.',
    coursesList: [
  ...
  },
  {
    ...
    bio: 'Ms. Patel brings a unique blend of industry design leadership and academic excellence. She previously led design teams at top tech companies and brings real-world UX methodology into every class.',
    coursesList: [
  ...
  },
  {
    ...
    bio: 'Dr. Lee specializes in cloud-native architectures and distributed computing systems. With certifications from all major cloud providers, he bridges the gap between theoretical knowledge and industry practice.',
    coursesList: [
...
function StarRating({ value }) {
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
      ...
      <span style={{ fontSize: 12, fontWeight: 700, color: '#f97316', marginLeft: 2 }}>{value}</span>
    </div>
  )
}
...
function LectureProfile() {
  ...
  return (
    <div style={{ maxWidth: 1100, margin: '0 auto', display: 'grid', gridTemplateColumns: '300px 1fr', gap: '1.5rem', alignItems: 'start' }}>
      {/* Lecturers list */}
      <div>
          ...
          {lecturers.map((l) => (
            ...
            >
              ...
              <div style={{ minWidth: 0 }}>
                <div style={{ fontSize: 13, fontWeight: 600, color: '#f0f0f0', marginBottom: 2 }}>{l.name}</div>
                <div style={{ fontSize: 11, color: '#666', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{l.title}</div>
              </div>
            </button>
          ))}
        </div>
      ...
      <div>
          ...
          <div style={{
            ...
            {[
              ...
              <div key={s.label} style={{ background: '#1e1e1e', padding: '0.9rem', textAlign: 'center' }}>
                <div style={{ fontSize: 22, fontWeight: 800, color: selected.color, letterSpacing: '-0.5px' }}>{s.value}</div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.25rem' }}>
          ...
          <div style={{
            ...
            <h3 style={{ margin: '0 0 0.75rem', fontSize: 14, fontWeight: 700, color: '#f0f0f0' }}>Contact & Office</h3>
            {[
          ...
          <div style={{
            ...
            <h3 style={{ margin: '0 0 0.75rem', fontSize: 14, fontWeight: 700, color: '#f0f0f0' }}>Courses Taught</h3>
              ...
              {selected.coursesList.map((c) => (
                <div key={c.code} style={{
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 3 }}>
                    <span style={{ fontSize: 12, fontWeight: 600, color: '#f0f0f0' }}>{c.name}</span>
                    <span style={{ fontSize: 11, fontWeight: 600, color: selected.color }}>{c.code}</span>
                  </div>
