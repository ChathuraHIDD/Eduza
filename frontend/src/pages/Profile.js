    ...
    <div style={{ maxWidth: 900, margin: '0 auto' }}>
        ...
        >
          <div
            style={{
              ...
              inset: 0,
              backgroundImage:
                'radial-gradient(circle at 20% 50%, rgba(249,115,22,0.2) 0%, transparent 50%), radial-gradient(circle at 80% 50%, rgba(168,85,247,0.15) 0%, transparent 50%)',
            }}
          />
        </div>
      ...
      {activeTab === 'Overview' && (
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.25rem' }}>
          ...
          >
            <h3 style={{ margin: '0 0 1rem', fontSize: 14, fontWeight: 700, color: '#f0f0f0' }}>
